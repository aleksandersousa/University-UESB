...
public class Util {
  ...
  public static boolean isKeyword(String term) {
    return term.matches(
      "(^(?i)(ABSOLUTE|ARRAY|BEGIN|CASE|CHAR|CONST|DIV|DO|DOWTO|ELSE|END|EXTERNAL|FILE|FOR|FORWARD|FUNC|FUNCTION|GOTO|IF|IMPLEMENTATION|INTEGER|INTERFACE|INTERRUPT|LABEL|MAIN|NIL|NIT|OF|PACKED|PROC|PROGRAM|REAL|RECORD|REPEAT|SET|SHL|SHR|STRING|THEN|TO|TYPE|UNIT|UNTIL|USES|VAR|WHILE|WITH|XOR|ANDa){0,}$)")
        ? true
        : false;
  }
