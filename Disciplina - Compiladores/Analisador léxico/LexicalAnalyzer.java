...
import lexical_compiler.Scanner;
import lexical_compiler.Token;
  ...
  public void run() {
    //LOGICA CRIAÇÂO DE ARQUIVO
      try   {
        ...
        //criação do txt com a analise no caminho -> sorces/outputs/output[NUMERO_OUTPUT].txt
        FileWriter file = new FileWriter(("sources/outputs/output" + outputName[OUTPUT_NUMBER] + "txt")); 
